...
public class RockPaperScissors {
	...
	String[] temp = new String[systemMoves.length];
        for (int i = 0; i < temp.length; i++)
		temp[i] = systemMoves[i];
	systemMoves = new String[systemMoves.length*2];
        for (int i = 0; i < temp.length; i++)
    ...
    void play(String playerMove, String sysMove) {
	    ...
	    else if (playerMove.equals(ROCK) || playerMove.equals(SCISSORS) || playerMove.equals(PAPER))
	    {
